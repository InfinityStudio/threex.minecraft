...
THREEx.MinecraftCharBodyAnimations = function (character) {
	...
	let tweenAngle = function (baseValue, nextValue, timePercent) {
	...
	let onUpdate = function (position) {
	...
	let onCapture = function (position) {
	...
	let angleRange = Math.PI / 3 - Math.PI / 10;
