...
// }
// f.readFile('./src.txt', (err, data) => {
//     const s = data.toString();
//     const lines = s.split('\n');
//     for (var index = 0; index < lines.length; index += 5) {
//         const version = lines[index];
//         let part = lines[index + 1];
//         const direction = lines[index + 2];
//         let pos = lines[index + 3]
//         pos = pos.replace('(', '[').replace(')', ']')
//         pos = JSON.parse(pos)
//         part = part.replace(/ /g, '')
//         part = part.charAt(0).toLowerCase() + part.substring(1);
//         if (!object[part]) object[part] = {}
//         object[part][direction.toLowerCase()] = pos;
//     }
//     console.log(object);
...
const conv = Buffer.from(defaultSkin, 'base64').toString('base64');
console.log(defaultSkin == conv)
